...
import pandas as pd
with open('url_collection','r') as fh:
...
row_iter = 0
org = 'Versa-Dev'
#cmds = ['request orgs org-services Versa-Dev url-filtering cloud-lookup lookup url webshar.es', 'request orgs org-services Versa-Dev url-filtering cloud-lookup lookup url webshar.us']
